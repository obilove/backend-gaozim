...
<head>
    ...
    <meta name="description" content="Gaozim is a tech driven waybilling and package delivery platform for ecommerce and domestic parcel." />
    <meta name="keywords"
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="{{asset('assets/images/gaozim/favicon.png')}}">
    <!-- Bootstrap -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    ...
                    <ul class="list-unstyled footer-list mt-4">
                        <li><a href="" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>
                                About us</a></li>
                                 <li><a href="{{ route('contact') }}" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>
                                Contact us</a></li>
                        <li><a href="#" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>
                                Careers</a></li>
                        <li><a href="#" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>
                ...
                <div class="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    ...
                    <ul class="list-unstyled footer-list mt-4">
                        <li><a href="page-terms.html" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>
                                Support</a></li>
                        <li><a href="{{ route('faq') }}" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>
                                FAQ</a></li>
                    </ul>
                </div>
                <!--end col-->
                ...
                <div class="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    ...
                    <ul class="list-unstyled footer-list mt-4">
                        <li><a href="https://gaozim.com/assets/images/app/policy.pdf" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i> Terms
                                of Services</a></li>
                        <li><a href="{{ route('privacy') }}" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>
                                Privacy Policy</a></li>
                        <li><a href="{{ route('guide') }}" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="text-sm-left">
                        <p class="mb-0">© {{ date('Y') }} Gaozim. Design with <i class="mdi mdi-heart text-danger"></i> by <a class="text-reset">Gaozim Technologies Limited</a>.
                        </p>
                    </div>
                </div>
                <!--end col-->
                ...
                <div class="col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <ul class="list-unstyled payment-cards text-sm-right mb-0">
                        <li class="list-inline-item"><a href="javascript:void(0)"><img
                                    src="{{asset('assets/images/payments/master-card.png')}}" title="Master Card" alt=""></a></li>

                        <li class="list-inline-item"><a href="javascript:void(0)"><img src="{{asset('assets/images/payments/visa.png')}}"
                                    title="Visa" alt=""></a></li>
                    </ul>
                </div>
                <!--end col-->
...
<!--End of Tawk.to Script-->
    ...
    <script src=" {{asset('assets/../../../unicons.iconscout.com/release/v2.1.9/script/monochrome/bundle.js')}}"></script>
    <!-- Switcher -->
